...
def _handle_jit_event(
    *,
    ...
    # Comment: GLM53 Golden — silence post-warmup JIT *warnings* (latency still
    # happens once per new shape). Set GLM53_JIT_MONITOR_SILENT=0 to restore
    # stock warn logs. Does not change kernels or decode quality.
    if os.environ.get("GLM53_JIT_MONITOR_SILENT", "1") != "0":
